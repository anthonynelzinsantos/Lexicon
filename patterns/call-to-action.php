...
<h2 class="wp-block-heading has-text-align-right align has-custom-contrasting-ink-color has-text-color has-link-color">Liked this post?</h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p>You can edit this pattern with the WordPress editor. It can be used to add a way to contact you, links to your social networks, or any other call to action.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->