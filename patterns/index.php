...
<h2 class="wp-block-heading has-text-align-right align has-custom-contrasting-ink-color has-text-color has-link-color"><?php esc_html_e('Liked this post?', 'lexicona17s');?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p><?php esc_html_e('You can edit this pattern from the WordPress editor. It can be used to add a way to contact you, links to your social networks, or any other call to action.', 'lexicona17s');?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
