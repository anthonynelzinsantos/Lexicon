...
echo sprintf( esc_html__( 'Image %1$sAlf van Beem%2$s (%3$sCC0 1.0 Public Dedication%4$s).', 'lexicon-a17s' ), '<a href="' . esc_url( 'https://commons.wikimedia.org/wiki/File:Peugeot_404_(1974)_,_Dutch_licence_registration_03-YA-61_pic3.JPG' ) . '" data-type="link" data-id="https://commons.wikimedia.org/wiki/File:Peugeot_404_(1974)_,_Dutch_licence_registration_03-YA-61_pic3.JPG">', '</a>', '<a href="' . esc_url( 'https://creativecommons.org/publicdomain/zero/1.0/' ) . '">', '</a>' ); ?></figcaption></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
