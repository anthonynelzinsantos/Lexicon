...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/peugeot-404.jpg" alt="" class=""/><figcaption class="wp-element-caption"><?php /* Translators: 1. is the start of a 'a' HTML element, 2. is the end of a 'a' HTML element, 3. is the start of a 'a' HTML element, 4. is the end of a 'a' HTML element */ echo sprintf( esc_html__( 'Image %1$sAlf van Beem%2$s (%3$sCC0 1.0 Public Dedication%4$s).', 'lexicon-a17s' ), '<a href="' . esc_url( 'https://commons.wikimedia.org/wiki/File:Peugeot_404_(1974)_,_Dutch_licence_registration_03-YA-61_pic3.JPG' ) . '" data-type="link" data-id="https://commons.wikimedia.org/wiki/File:Peugeot_404_(1974)_,_Dutch_licence_registration_03-YA-61_pic3.JPG">', '</a>', '<a href="' . esc_url( 'https://creativecommons.org/publicdomain/zero/1.0/' ) . '">', '</a>' ); ?></figcaption></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<p><?php /* Translators: 1. is the start of a 'a' HTML element, 2. is the end of a 'a' HTML element, 3. is the start of a 'a' HTML element, 4. is the end of a 'a' HTML element */ echo sprintf( esc_html__( 'This is most unfortunate. This page might have been removed… or never existed in the first place. You can try to %1$ssearch it%2$s or %3$sgo back to the homepage%4$s. ', 'lexicon-a17s' ), '<a href="' . esc_url( '/?s=' ) . '">', '</a>', '<a href="' . esc_url( '/' ) . '">', '</a>' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
